...
public class MessageInfoUtil {
    ...
    private static boolean isTyping(byte[] data) {
        try {
            ...
            Util.INSTANCE.printLog("parse json error");
        }
        return false;
    }
    ...
    public static MessageInfo createMessageInfo(V2TIMMessage timMessage) {
        if (timMessage == null
            ...
            Util.INSTANCE.printLog("ele2MessageInfo parameters error");
            return null;
        }
        ...
        if (type == V2TIMMessage.V2TIM_ELEM_TYPE_CUSTOM) {
            ...
            if (data.equals(MessageCustom.BUSINESS_ID_GROUP_CREATE)) {
                ...
                try {
                    ...
                    Util.INSTANCE.printLog("invalid json: " + data + ", exception:" + e);
                }
            }
            ...
            if (type == V2TIMMessage.V2TIM_ELEM_TYPE_TEXT) {
                ...
                if (faceElem.getIndex() < 1 || faceElem.getData() == null) {
                    Util.INSTANCE.printLog("faceElem data is null or index<1");
                    return null;
                }
                    ...
                    if (!file.exists()) {
                        soundElemEle.downloadSound(path, new V2TIMDownloadCallback() {
                            ...
                            public void onProgress(V2TIMElem.V2ProgressInfo progressInfo) {
                                ...
                                Util.INSTANCE.printLog("MessageInfoUtil getSoundToFile :  progress:" + progress);
                            }

                            @Override
                            public void onError(int code, String desc) {
                                Util.INSTANCE.printLog("MessageInfoUtil getSoundToFile :  " + code + ":" + desc);
                            }

...
public class TUIKitConstants {
    ...
    /*    public static String APP_DIR = ImHelper.getConfigs().getGeneralConfig().getAppCacheDir() != null
                ? TUIKit.getConfigs().getGeneralConfig().getAppCacheDir()
                : SD_CARD_PATH + "/" + TUIKit.getAppContext().getPackageName();*/
    public static String APP_DIR = ImHelper.INSTANCE.getMContext().getPackageName();
